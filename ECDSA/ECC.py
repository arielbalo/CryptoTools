...
#print(f'Representacion de la curva:\n{secp256k1}')
...
#print(f'Punto generador G:\n{G}')
#print(f'Orden n:\n{N}')

I = Point(x=None, y=None, curve=secp256k1)

#print(f'Punto en el infinito:\n{I}')
...
try:
    assert N * G == I
    #print("Prueba de multiplicacion escalar 1 superada.")
except AssertionError:
    print("Error en la prueba de multiplicacion escalar 1.")
...
try:
    assert e * G == pub
    #print("Prueba de multiplicacion escalar 2 superada.")
except:
    print("Error en la prueba de multiplicacion escalar 2.")
